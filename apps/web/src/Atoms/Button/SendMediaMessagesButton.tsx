...
const SendMediaMessagesButton: FC<ISendedMessagesButton> = ({ count = 0, isLoading, ...props }) => {
  return (
    <button className='rounded-full h-[50px] w-[50px] bg-whatsapp-misc-whatsapp_primary_green_light relative justify-center place-items-center flex disabled:cursor-not-allowed' {...props} disabled={isLoading}>
